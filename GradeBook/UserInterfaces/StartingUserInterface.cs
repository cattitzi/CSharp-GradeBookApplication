...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            {
                Console.WriteLine("{0} is not a type of gradebook, please try again.", type);
                return;
            }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' - Creates a new gradebook where 'Name' is the name of the gradebook and  'Type' is what kind of grading it shoule use.");
            Console.WriteLine();
